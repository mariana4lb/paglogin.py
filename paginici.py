...
class Login(BoxLayout):
    def __init__(self, arg1=None, arg2=None, **kwargs):
        Window.clearcolor = get_color_from_hex("#ffcbdb")
        ...
        self.add_widget(AsyncImage(source='https://i.pinimg.com/736x/95/34/b8/9534b84fab03ac737b369f2ac5895ae7.jpg'))
        
        self.add_widget(Label(text="LOGIN", font_size=40, font_name='Impact', color=get_color_from_hex('#C75B7A')))
        ...
        self.add_widget(Label(text="Nome de usuário:", font_name='Arial', color=get_color_from_hex('#C75B7A'), font_size=20))
        self.add_widget(self.username_input)
        self.add_widget(Label(text="Senha:", font_name='Arial', color=get_color_from_hex('#C75B7A'), font_size=20))
        self.add_widget(self.senha_input)
        
        
        self.cadastrar_button = Button(text="Entrar", background_color=get_color_from_hex('#C75B7A'))
        self.login_button = Button(text="Não possui uma conta? Cadastre-se", background_color=get_color_from_hex('#C75B7A'))
